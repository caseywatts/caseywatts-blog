...
description: If they can't answer these questions upfront? They won't come to your event! Try out this interactive checklist I use when I write event descriptions ✅
heroImage: "/assets/images/emoji-hugging-face.png"
...
import InputToLocalStorage from "../../components/InputToLocalStorage.svelte";
...
<ul>
  <CheckboxListItem id="values">Values: What is the purpose/values of this group?</CheckboxListItem>
  <CheckboxListItem id="audience">Audience: Who is this group for?</CheckboxListItem>
  <CheckboxListItem id="leadership">Leadership: Who runs the group? (is it [community-led or company led](https://www.happyandeffective.com/blog/community-groups-community-led-vs-company-led) ?)</CheckboxListItem>
  <CheckboxListItem id="spansored">Sponsorship: Who pays for it?</CheckboxListItem>
</ul>

#### Getting Involved

<ul>
  <CheckboxListItem id="connection">Connection: Can we also talk outside of the event? (Slack/Discord?)</CheckboxListItem>
  <CheckboxListItem id="contributing">Contribution: Can people like me get involved organizing/volunteering? How?</CheckboxListItem>
</ul>

#### Safety

<ul>
  <CheckboxListItem id="guidelines">Guidelines: Code of Conduct?</CheckboxListItem>
  <CheckboxListItem id="enforcement">Enforcement: Clear reporting / enforcement process?</CheckboxListItem>
  <CheckboxListItem id="not-alone">Not Alone: Will I be the only person like me there? (experience, race, gender, sexuality)</CheckboxListItem>
</ul>
...
<ul>
  <CheckboxListItem id="descriptive-title">Descriptive Title: From the title alone, would someone know what the event is?</CheckboxListItem>
</ul>

#### Event Details

<ul>
  <CheckboxListItem id="agenda">Agenda: What will we do there?</CheckboxListItem>
  <CheckboxListItem id="cost">Cost: Does it cost money?</CheckboxListItem>
</ul>

#### Safety

<ul>
  <CheckboxListItem id="covid">Covid details? (ventilation, masks)</CheckboxListItem>
</ul>

#### Getting There

<ul>
  <CheckboxListItem id="transportation">Transportation: Parking? Free/paid? Public transit?</CheckboxListItem>
</ul>

#### Getting In

<ul>
  <CheckboxListItem id="getting-in">Geting In: How will I know I'm in the right place? How will I get in?</CheckboxListItem>
  <CheckboxListItem id="coming-late">Coming Late: If I come late, how will I get in?</CheckboxListItem>
</ul>
...
import ClearLocalStorage from "../../components/ClearLocalStorage.svelte";

<CheckboxCounter />
<ClearLocalStorage client:only="svelte" />
...
<InputToLocalStorage client:only="svelte" />
