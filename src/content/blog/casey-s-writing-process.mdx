...
tagline: How I wrote, edited, and self-published Debugging Your Brain
pubDate: "2022-6-22"
tags: ["💡 Tips"]
heroImage: /assets/images/emoji-writing-hand.png
---

_Also check out: my [technical setup for self-publishing](https://caseywatts.com/selfpublish)_
...
1. First I found myself **discussing** these topics with friends.
2. Then I gave some talks at **local tech meet-ups** and tech conferences.
3. Eventually I was giving talks at **bigger tech conferences**, and even keynote a couple of times.
4. When I was ready to turn the talk into a book, I used a **YouTube transcription** as a base for my book - but of course that was totally illegible! I turned it into sentences and paragraphs, and I made those into **blog posts**. The short-term goal of it kept me motivated to write - I knew I wanted the blog posts up!

Once the blog posts were up, I was so close to having a book -- and yet still so far!

### How did I edit the book?

Eventually I was ready to turn it into a full book. I took a 2-month sabbatical in August and September 2020. It took two months of editing and incorporating feedback for the book to become "done" and publishable. I got feedback from 40 friends; I could not have done this without you all!

With so many editors, I'm thrilled with the quality of the book. It's [published](https://www.debuggingyourbrain.com), as of November 1, 2020.

### How did I format the book?

Once the "manuscript" is done (the unformatted text), you have to format it for print and ebook. I wrote my manuscript in markdown, which helped the computer produce the pdf for printing and epub for ebook. I used the tool [pandoc](https://pandoc.org/MANUAL.html) to convert my files for me, using this [technical setup](https://www.caseywatts.com/selfpublish). For my text editor I used [Zettlr](https://www.zettlr.com/) which is very good for this: it does markdown AND tracking images AND tracking citations. I would totally recommend Zettlr for any research papers going forward!

### How did I self-publish the paper book / eBook?

I used [IngramSpark](https://www.ingramspark.com/) to publish and distribute my print and eBook versions. They even distribute to libraries, which is something I care about a lot!
...
For the audiobook I used [Findaway Voices](https://findawayvoices.com/) for publishing and distribution. Its interface is more polished than IngramSpark, and there were no gotchas at all!
