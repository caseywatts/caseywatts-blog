...
If you have access to Google Analytics (or equivalent), you could cross-reference your own traffic, using something like [browserslist-ga-export](https://github.com/browserslist/browserslist-ga-export).

Here's my calculation:

* Using data from before April (before the Firefox 11 spike happened, [see my bug report](https://github.com/browserslist/browsersl.ist/issues/540))  
